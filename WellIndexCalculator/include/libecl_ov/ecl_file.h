...
/*               R E S T A R T  F I L E S                        */
  ...
  time_t           ecl_file_get_restart_sim_date( const ecl_file_type * restart_file );
  time_t           ecl_file_iget_restart_sim_date( const ecl_file_type * restart_file , int occurence );
  time_t           ecl_file_iget_named_kw_sim_date( const ecl_file_type * restart_file , const char * kw, int named_kw_index );
